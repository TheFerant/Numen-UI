...
import { useTheme, Popover, Themes } from '../../../../src/components'
import { numenUIThemesPalette } from '../../../../src/components/themes'
...
interface Props {
  value?: string
  keyName: keyof numenUIThemesPalette
}
...
const getRandomColors = () => {
  const kyes = Object.keys(DefaultTheme.palette) as Array<keyof numenUIThemesPalette>
