...
import { Text, Button, useTheme, Themes } from '../../../../src/components'
import { numenUIThemesExpressiveness, numenUIThemesPalette } from '../../../../src/components/themes'

import RotateCcwIcon from '@numen-ui/icons/rotateCcw'

import EditorColorItem from './editor-color-item'
import EditorInputItem from './editor-input-item'
import { useConfigs } from 'lib/config-context'

const basicColors: Array<keyof numenUIThemesPalette> = [
  'accents_1',
  'accents_2',
  'accents_3',
  'accents_4',
...
const statusColors: Array<keyof numenUIThemesPalette> = [
  'success',
  'successLight',
  'successDark',
  'error',
...
const otherColors: Array<keyof numenUIThemesPalette> = [
  'selection',
  'secondary',
  'link',
  'border',
...
const expressiveness: Array<keyof numenUIThemesExpressiveness> = [
  'linkStyle',
  'linkHoverStyle',
  'dropdownBoxShadow',
  'shadowSmall',
...
// const pageLayout: Array<keyof numenUIThemesLayout> = [
//   'pageWidth',
//   'pageWidthWithMargin',
//   'pageMargin',
//   'radius',
// ]
// const gapLayout: Array<keyof numenUIThemesLayout> = [
//   'gap',
//   'gapNegative',
//   'gapHalf',
//   'gapHalfNegative',
