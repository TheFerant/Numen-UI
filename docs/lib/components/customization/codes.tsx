...
import { isObject } from '../../../../src/components/themes/themes'
import CopyIcon from '../../../../src/components/snippet/snippet-icon'
import { Text, Spacer, useTheme, Code, useToasts, Themes, useClipboard } from '../../../../src/components'
 ...
 *  export const App = () => {
 *    return (
 *      <NumenProvider themes={[myTheme]} themeType="${CUSTOM_THEME_TYPE}">
 *        <CssBaseline />
 *        <YourComponent />
 *      </NumenProvider>
 *    )
