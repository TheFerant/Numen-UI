...
import { numenUIThemes } from 'components/themes/presets'
...
const getBackground = (theme: numenUIThemes, plain: number | boolean) => {
...
ExampleBlock.displayName = 'numenExampleBlock'
