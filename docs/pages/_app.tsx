...
import { CssBaseline, NumenProvider, useTheme, numenUIThemes, Image } from '../../src/components'
...
const Application: NextPage<AppProps<{}>> = ({ Component, pageProps }) => {
  ...
  const themeChangeHandle = (theme: numenUIThemes) => {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://numen-ui.dev" />
        <link rel="dns-prefetch" href="//numen-ui.dev" />
      ...
      <NumenProvider themeType={themeType} themes={[customTheme]}>
        <CssBaseline />
        <ConfigContext
