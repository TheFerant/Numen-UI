...
Also, numen is based on the component library of framework React, which means you must also understand the basics of how to [create projects](https://reactjs.org/docs/hello-world.html) with the framework
...
<Tabs initialValue="yarn" hideDivider hideBorder align="flex-end" mt="-46px">
  <Tabs.Item label="Yarn" value="yarn">
    <Snippet>yarn add @numen-ui/core</Snippet>
  </Tabs.Item>
  <Tabs.Item label="Npm" value="npm">
    <Snippet>npm i @numen-ui/core</Snippet>
  </Tabs.Item>
</Tabs>
<Spacer h={0.5} />
<h4>
...
```jsx
import { Button, Page, Text } from '@numen-ui/core'
...
In addition, here is a complete [project example](https://github.com/numen-org/react-getting-started) using numen on CRA for reference.

### Next.js project

[Next.js](https://nextjs.org/) is a React server-side rendering framework. Using numen on framework Next.js requires custom `_app.jsx` files,
...
In addition, we have provided a complete [Next.js application](https://github.com/numen-org/numen-ui/blob/master/examples/create-next-app/README.md) example for reference.
