...
The size of numen at the completion of full packing is about [111kb](https://bundle.js.org/?q=@numen-ui/react) (Gzipped),
...
As a matter of engineering practice, it is recommended that you always split numen as a separate chunk within your application to get fixed caching.
...
As long as you use the ES module to import numen, you can automatically remove unnecessary components during bundle.
...
- [CRA with TreeShaking](https://github.com/numen-org/numen-ui/blob/master/examples/tree-shaking-create-react-app/README.md)
- [Next.js with TreeShaking](https://github.com/numen-org/numen-ui/blob/master/examples/tree-shaking-nextjs/README.md)
- [Webpack with TreeShaking](https://github.com/numen-org/numen-ui/blob/master/examples/tree-shaking-webpack/README.md)
...
```jsx
import Button from '@numen-ui/core/esm/button'
...
numen follows the Tree Shaking naming scheme (from community convention), this will be helpful for some legacy projects.
...
- [CRA with Babel](https://github.com/numen-org/numen-ui/blob/v2.3.3/examples/tree-shaking-create-react-app/README.md)
- [Next.js with Babel](https://github.com/numen-org/numen-ui/blob/v2.3.3/examples/tree-shaking-nextjs/README.md)
- [Webpack with Babel](https://github.com/numen-org/numen-ui/blob/v2.3.3/examples/tree-shaking-webpack/README.md)
