...
import { Note, Display, Button } from "@numen-ui/core";
...
<Note type="warning">
  This feature was introduced in v2.2.0 and up. If you’re using older versions
  of Geist, please upgrade before trying it out.
</Note>
