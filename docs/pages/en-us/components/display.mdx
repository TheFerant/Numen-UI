...
<Playground
  ...
  <Display shadow caption="An open-source design system for building modern websites and applications.">
    <Image width="435px" height="200px" src="/images/numen-banner.png" />
  </Display>
`}
/>
...
<Display width="500px" caption="Run this command to install the library.">
  <Snippet type="dark">yarn add @numen-ui/core</Snippet>
</Display>
`}
/>
...
<Playground
  ...
  code={`
  <Display shadow caption={<p>Browse <Code>numen-ui.dev</Code> for more documentation.</p>}>
    <Image width="650px" height="297px" src="/images/numen-banner.png" />
  </Display>
`}
/>
