...
import GitIcon from '@numen-ui/icons/github'
...
<Playground
  ...
  scope={{ Input }}
  code={`
<Input placeholder="numen UI" width="100%" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Input label="username" placeholder="numen UI" />
  <Spacer h={.5} />
...
<Playground
  ...
  code={`
<>
  <Input type="secondary" initialValue="numen UI" />
  <Spacer h={.5} />
  <Input type="success" initialValue="numen UI" />
  <Spacer h={.5} />
  <Input type="warning" initialValue="numen UI" />
  <Spacer h={.5} />
  <Input type="error" initialValue="numen UI" />
</>
`}
/>
...
<Playground
  ...
  code={`
<>
  <Input clearable initialValue="numen UI" placeholder="numen UI" />
</>
`}
/>
...
() => {
  ...
  return (
    <Input value={value} onChange={handler} placeholder="numen UI" />
  )
}
`}
/>
