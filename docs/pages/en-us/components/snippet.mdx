...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet text="yarn add @numen-ui/core" width="300px" />
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet text="yarn add @numen-ui/core" width="100%" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Snippet text="yarn add @numen-ui/core" type="dark" width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="success" width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="warning" width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="error" width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="secondary" width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="lite" width="300px" />
</>
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet copy="prevent" text="yarn add @numen-ui/core" width="300px" />
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet symbol=">" text="yarn add @numen-ui/core" width="300px" />
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet toastText="Code copied!" toastType="secondary" text="yarn add @numen-ui/core" width="300px" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Snippet text="yarn add @numen-ui/core" type="success" filled width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="warning" filled width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="error" filled width="300px" />
  <Spacer />
  <Snippet text="yarn add @numen-ui/core" type="secondary" filled width="300px" />
</>
`}
/>
