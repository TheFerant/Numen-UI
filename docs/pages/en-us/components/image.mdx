...
<Playground
  ...
  scope={{ Image }}
  code={`
<Image width="280px" height="160px" src="/images/numen-banner.png" />
`}
/>
...
<Image width="280px" height="160px"
  src="http://www.deelay.me/2000/https://numen-ui.dev/images/numen-banner.png" />
`}
/>
...
<Playground
  ...
  code={`
<Image.Browser url="https://numen-ui.dev/en-us/guide/introduction" anchorProps={{ rel: 'nofollow' }}>
  <Image width="525px" height="300px" src="/images/numen-banner.png" />
</Image.Browser>
`}
/>
...
<Playground
  ...
  scope={{ Image, Display, Code }}
  code={`
<Image.Browser url="https://numen-ui.dev/en-us/guide/introduction" invert>
  <Image width="525px" height="300px" src="/images/numen-banner-dark.png" />
</Image.Browser>
`}
/>
...
<Display shadow caption={<p>Set the <Code>height</Code> to reduces the possibility of page rerender.</p>}>
  <Image height="246px" src="/images/numen-banner-text.png" />
</Display>
`}
/>
