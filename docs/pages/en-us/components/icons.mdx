...
import Github from '@numen-ui/icons/github'
...
<Tabs initialValue="yarn">
  <Tabs.Item label="Yarn" value="yarn">
    <Spacer h={0.6} />
    <Snippet width="400px">yarn add @numen-ui/icons</Snippet>
  </Tabs.Item>
  <Tabs.Item label="npm" value="npm">
    <Spacer h={0.6} />
    <Snippet width="400px">npm i @numen-ui/icons</Snippet>
  </Tabs.Item>
</Tabs>
...
<Playground
  ...
  scope={{ Github, Spacer }}
  code={`
// import * as Icon from '@numen-ui/icons'
// or
// import { Github } from '@numen-ui/icons'
// or, for tree-shaking:
// import Github from '@numen-ui/icons/github'
