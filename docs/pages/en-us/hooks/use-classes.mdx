...
there are not a lot of complex class-names expressions to deal with in _numen_, just for regular space sign removal.
...
```tsx
import { useClasses } from '@numen-ui/core'
