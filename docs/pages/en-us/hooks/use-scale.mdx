...
which gave the numen components amazing imagination and extensibility,
...
Now we try to bind the component to the scale of numen:

```tsx
import { withScale, useScale } from '@numen-ui/core'
